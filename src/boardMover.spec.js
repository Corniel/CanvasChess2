...
describe('BoardMover', () => {
    ...
    it('can promote a pawn to a queen by default', () => {
        ...
        // White
        boardMover.playMove(getMove('e7', 'e8'));
        expect(position.fen).toBe('4Q3/7k/8/8/8/8/3p3K/8 b - - 0 1');

        // Black
        boardMover.playMove(getMove('d2', 'd1'));
