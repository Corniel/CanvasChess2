...
/***/ function(module, exports, __webpack_require__) {
	...
	var _square = __webpack_require__(298);

	var _move = __webpack_require__(299);

	var _position = __webpack_require__(300);

	var _pieceMover = __webpack_require__(302);

	module.exports = {
	    Square: _square.Square,
	    Move: _move.Move,
	    Position: _position.Position,
	    PieceMover: _pieceMover.PieceMover
	};
...
/***/ function(module, exports) {
	...
	var Square = exports.Square = function () {
	    ...
	    _createClass(Square, [{
	        ...
	        key: 'addRank',
	        value: function addRank(i) {
	            var newName = this.file + (parseInt(this.rank, 10) + i);
	            this.name = newName;
	        }
	        ...
	        key: 'isSameFile',
	        value: function isSameFile(square) {
	        ...
	        key: 'isSameRank',
	        value: function isSameRank(square) {
	        ...
	        key: 'diffFile',
	        value: function diffFile(square) {
	        ...
	        key: 'diffRank',
	        value: function diffRank(square) {
	        ...
	        key: 'isBishopMove',
	        value: function isBishopMove(square) {
	        ...
	        key: 'isKingMove',
	        value: function isKingMove(square) {
	            if (this.equals(square)) {
	                return false;
	            }
	        ...
	        key: 'isKnightMove',
	        value: function isKnightMove(square) {
	            if (this.equals(square)) {
	                return false;
	            }
	            return Math.abs(this.diffRank(square)) === 1 && Math.abs(this.diffFile(square)) === 2 || Math.abs(this.diffRank(square)) === 2 && Math.abs(this.diffFile(square)) === 1;
	        }
	        ...
	        key: 'isQueenMove',
	        value: function isQueenMove(square) {
	            if (this.equals(square)) {
	                return false;
	            }
	        ...
	        key: 'isRookMove',
	        value: function isRookMove(square) {
	            if (this.equals(square)) {
	                return false;
	            }
	         ...
	         */
	        ,
	        set: function set(newFile) {
	            var name = newFile + this.rank;
	            this.name = name;
	        }
	        ...
	        key: 'getAllSquares',
	        value: function getAllSquares() {
	            var squareList = [];

	            for (var i = 1; i <= 8; i++) {
	                for (var j = 1; j <= 8; j++) {
	                    var square = new Square(String.fromCharCode(i + 96) + j);
	...
	function addNumberToCharacter(number, character) {
	    var currentFileNumber = void 0,
	        newFileNumber = void 0,
	        fileCharacter = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	exports.Move = function Move(startSquare, endSquare) {
	    _classCallCheck(this, Move);

	    if (!startSquare || !endSquare) {
	        throw new Error('A move must have a start square and an end square');
	    }
	    if (!(startSquare instanceof _square.Square && endSquare instanceof _square.Square)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _piece = __webpack_require__(301);
	...
	var Position = exports.Position = function () {
	    ...
	    _createClass(Position, [{
	        ...
	        key: 'canBlackCastleKingside',
	        value: function canBlackCastleKingside() {
	        ...
	        key: 'canBlackCastleQueenside',
	        value: function canBlackCastleQueenside() {
	        ...
	        key: 'canWhiteCastleKingside',
	        value: function canWhiteCastleKingside() {
	        ...
	        key: 'canWhiteCastleQueenside',
	        value: function canWhiteCastleQueenside() {
	        ...
	        key: 'getColorNotToMove',
	        value: function getColorNotToMove() {
	        ...
	        key: 'setBlackCastleKingside',
	        value: function setBlackCastleKingside() {
	            var canCastle = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
	        ...
	        key: 'setBlackCastleQueenside',
	        value: function setBlackCastleQueenside() {
	            var canCastle = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
	        ...
	        key: 'setWhiteCastleKingside',
	        value: function setWhiteCastleKingside() {
	            var canCastle = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
	        ...
	        key: 'setWhiteCastleQueenside',
	        value: function setWhiteCastleQueenside() {
	            var canCastle = arguments.length <= 0 || arguments[0] === undefined ? true : arguments[0];
	        ...
	        value: function getPiece(square) {
	            var x = square.file,
	                y = square.rank,
	                pieceAndColor = void 0;

	            x = x.charCodeAt(0) - 97, y = 8 - y;
	        ...
	        value: function setPiece(square, piece) {
	            ...
	            if (typeof square === 'string') {
	                square = new _square.Square(square);
	            }
	        ...
	        key: 'findPiece',
	        value: function findPiece(piece) {
	            var squares = [];

	            for (var i = 0; i < this._positionArray.length; i++) {
	                for (var j = 0; j < this._positionArray[i].length; j++) {
	                    if (this._positionArray[i][j] === piece.color + piece.type) {
	                        squares.push(new _square.Square(getSquareName(j, i)));
	                    }
	                }
	            }
	        ...
	        key: 'fen',
	        get: function get() {
	            return [dataToFenPosition(this._positionArray), this._colorToMove, dataToFenCastling(this._castleWK, this._castleWQ, this._castleBK, this._castleBQ), this._enPassant, '0 1'].join(' ');
	        }
	...
	function dataToFenPosition(positionArray) {
	    ...
	    for (var rowNumber = 0; rowNumber < positionArray.length; rowNumber += 1) {
	...
	function dataToFenPositionRow(positionArray, rowNumber) {
	    ...
	    for (var columnNumber = 0; columnNumber < positionArray[rowNumber].length; columnNumber += 1) {
...
/***/ function(module, exports) {
	...
	var Pawn = exports.Pawn = function (_Piece) {
	    ...
	    function Pawn(color) {
	        ...
	        var _this = _possibleConstructorReturn(this, (Pawn.__proto__ || Object.getPrototypeOf(Pawn)).call(this, color));
	...
	var Knight = exports.Knight = function (_Piece2) {
	    _inherits(Knight, _Piece2);

	    function Knight(color) {
	        _classCallCheck(this, Knight);

	        var _this2 = _possibleConstructorReturn(this, (Knight.__proto__ || Object.getPrototypeOf(Knight)).call(this, color));
	...
	var Bishop = exports.Bishop = function (_Piece3) {
	    _inherits(Bishop, _Piece3);

	    function Bishop(color) {
	        _classCallCheck(this, Bishop);

	        var _this3 = _possibleConstructorReturn(this, (Bishop.__proto__ || Object.getPrototypeOf(Bishop)).call(this, color));
	...
	var Rook = exports.Rook = function (_Piece4) {
	    _inherits(Rook, _Piece4);

	    function Rook(color) {
	        _classCallCheck(this, Rook);

	        var _this4 = _possibleConstructorReturn(this, (Rook.__proto__ || Object.getPrototypeOf(Rook)).call(this, color));
	...
	var Queen = exports.Queen = function (_Piece5) {
	    _inherits(Queen, _Piece5);

	    function Queen(color) {
	        _classCallCheck(this, Queen);

	        var _this5 = _possibleConstructorReturn(this, (Queen.__proto__ || Object.getPrototypeOf(Queen)).call(this, color));
	...
	var King = exports.King = function (_Piece6) {
	    _inherits(King, _Piece6);

	    function King(color) {
	        _classCallCheck(this, King);

	        var _this6 = _possibleConstructorReturn(this, (King.__proto__ || Object.getPrototypeOf(King)).call(this, color));
	...
	var NullPiece = exports.NullPiece = function () {
	    function NullPiece() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PieceMover = exports.PieceMover = function () {
	    /**
	     * Create a PieceMover for a given position.
	     * @param {Position} position - The initial position.
	     */
	    function PieceMover(position) {
	        _classCallCheck(this, PieceMover);
	    ...
	    _createClass(PieceMover, [{
	        key: 'playMove',
	        value: function playMove(move, promotionPiece) {
	            var capturedPiece = void 0,
	                piece = void 0,
	                startSquare = void 0,
	                endSquare = void 0;
	...
	function promotePawn(position, endSquare, promotionPiece) {
	    var color = endSquare.rank === '8' ? 'w' : 'b';
	...
	function removeEnPassantPiece(position, endSquare) {
	    var enPassantSquare = endSquare.clone(),
	...
	function castleKingsideWithRook(position, startSquare) {
	    var rank = startSquare.rank,
	        piece = position.getPiece(new _square.Square('h' + rank));

	    position.setPiece(new _square.Square('f' + rank), piece);
	    position.setPiece(new _square.Square('h' + rank), new Piece.NullPiece());
	}

	function castleQueensideWithRook(position, startSquare) {
	    var rank = startSquare.rank,
	        piece = position.getPiece(new _square.Square('a' + rank));

	    position.setPiece(new _square.Square('d' + rank), piece);
	    position.setPiece(new _square.Square('a' + rank), new Piece.NullPiece());
	}
